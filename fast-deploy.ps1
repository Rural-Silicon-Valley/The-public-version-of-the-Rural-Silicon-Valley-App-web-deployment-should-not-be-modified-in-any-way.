...
$result = scp -o StrictHostKeyChecking=no ".\dist.zip" "root@116.62.56.214:/var/www/html/"
...
ssh -o StrictHostKeyChecking=no "root@116.62.56.214" "cd /var/www/html; unzip -o dist.zip; rm dist.zip"
